...
* [Breaking] Refactored build matrix to invoke `zig build` CLI instead of using a custom build step since that functionality is being removed in Zig version 0.17.0.
### Fixed
### Removed
